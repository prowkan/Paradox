...
void RenderDeviceD3D11::InitDevice()
{
	...
	{
		void *FullScreenQuadVertexShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.FullScreenQuad");
		size_t FullScreenQuadVertexShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.FullScreenQuad");

		SAFE_DX(Device->CreateVertexShader(FullScreenQuadVertexShaderByteCodeData, FullScreenQuadVertexShaderByteCodeLength, nullptr, &FullScreenQuadVertexShader));
	}
...

	{
		...
		void *MSAADepthResolvePixelShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.MSAADepthResolve");
		SIZE_T MSAADepthResolvePixelShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.MSAADepthResolve");

		SAFE_DX(Device->CreatePixelShader(MSAADepthResolvePixelShaderByteCodeData, MSAADepthResolvePixelShaderByteCodeLength, nullptr, &MSAADepthResolvePixelShader));
	}
...

	{
		...
		void *OcclusionBufferPixelShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.OcclusionBuffer");
		SIZE_T OcclusionBufferPixelShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.OcclusionBuffer");

		SAFE_DX(Device->CreatePixelShader(OcclusionBufferPixelShaderByteCodeData, OcclusionBufferPixelShaderByteCodeLength, nullptr, &OcclusionBufferPixelShader));
	}
...

	{
		...
		void *ShadowResolvePixelShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.ShadowResolve");
		SIZE_T ShadowResolvePixelShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.ShadowResolve");

		SAFE_DX(Device->CreatePixelShader(ShadowResolvePixelShaderByteCodeData, ShadowResolvePixelShaderByteCodeLength, nullptr, &ShadowResolvePixelShader));
	}
...

	{
		...
		void *DeferredLightingPixelShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.DeferredLighting");
		SIZE_T DeferredLightingPixelShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.DeferredLighting");

		SAFE_DX(Device->CreatePixelShader(DeferredLightingPixelShaderByteCodeData, DeferredLightingPixelShaderByteCodeLength, nullptr, &DeferredLightingPixelShader));
	}

	// ===============================================================================================================

	{
		void *FogPixelShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.Fog");
		SIZE_T FogPixelShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.Fog");

		SAFE_DX(Device->CreatePixelShader(FogPixelShaderByteCodeData, FogPixelShaderByteCodeLength, nullptr, &FogPixelShader));
		...
		void *SkyVertexShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.SkyVertexShader");
		SIZE_T SkyVertexShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.SkyVertexShader");

		void *SkyPixelShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.SkyPixelShader");
		SIZE_T SkyPixelShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.SkyPixelShader");

		SAFE_DX(Device->CreateVertexShader(SkyVertexShaderByteCodeData, SkyVertexShaderByteCodeLength, nullptr, &SkyVertexShader));
		SAFE_DX(Device->CreatePixelShader(SkyPixelShaderByteCodeData, SkyPixelShaderByteCodeLength, nullptr, &SkyPixelShader));
		...
		void *SunVertexShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.SunVertexShader");
		SIZE_T SunVertexShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.SunVertexShader");

		void *SunPixelShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.SunPixelShader");
		SIZE_T SunPixelShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.SunPixelShader");

		SAFE_DX(Device->CreateVertexShader(SunVertexShaderByteCodeData, SunVertexShaderByteCodeLength, nullptr, &SunVertexShader));
		SAFE_DX(Device->CreatePixelShader(SunPixelShaderByteCodeData, SunPixelShaderByteCodeLength, nullptr, &SunPixelShader));
		...
		SAFE_DX(Device->CreateInputLayout(InputElementDescs, 5, SkyVertexShaderByteCodeData, SkyVertexShaderByteCodeLength, &SkyAndSunInputLayout));
	}
...

	{
		...
		void *LuminanceCalcComputeShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.LuminanceCalc");
		SIZE_T LuminanceCalcComputeShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.LuminanceCalc");

		void *LuminanceSumComputeShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.LuminanceSum");
		SIZE_T LuminanceSumComputeShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.LuminanceSum");

		void *LuminanceAvgComputeShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.LuminanceAvg");
		SIZE_T LuminanceAvgComputeShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.LuminanceAvg");

		SAFE_DX(Device->CreateComputeShader(LuminanceCalcComputeShaderByteCodeData, LuminanceCalcComputeShaderByteCodeLength, nullptr, &LuminanceCalcComputeShader));
		SAFE_DX(Device->CreateComputeShader(LuminanceSumComputeShaderByteCodeData, LuminanceSumComputeShaderByteCodeLength, nullptr, &LuminanceSumComputeShader));
		SAFE_DX(Device->CreateComputeShader(LuminanceAvgComputeShaderByteCodeData, LuminanceAvgComputeShaderByteCodeLength, nullptr, &LuminanceAvgComputeShader));
	}
...

	{
		...
		void *BrightPassPixelShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.BrightPass");
		SIZE_T BrightPassPixelShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.BrightPass");

		void *ImageResamplePixelShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.ImageResample");
		SIZE_T ImageResamplePixelShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.ImageResample");

		void *HorizontalBlurPixelShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.HorizontalBlur");
		SIZE_T HorizontalBlurPixelShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.HorizontalBlur");

		void *VerticalBlurPixelShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.VerticalBlur");
		SIZE_T VerticalBlurPixelShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.VerticalBlur");

		SAFE_DX(Device->CreatePixelShader(BrightPassPixelShaderByteCodeData, BrightPassPixelShaderByteCodeLength, nullptr, &BrightPassPixelShader));
		SAFE_DX(Device->CreatePixelShader(ImageResamplePixelShaderByteCodeData, ImageResamplePixelShaderByteCodeLength, nullptr, &ImageResamplePixelShader));
		SAFE_DX(Device->CreatePixelShader(HorizontalBlurPixelShaderByteCodeData, HorizontalBlurPixelShaderByteCodeLength, nullptr, &HorizontalBlurPixelShader));
		SAFE_DX(Device->CreatePixelShader(VerticalBlurPixelShaderByteCodeData, VerticalBlurPixelShaderByteCodeLength, nullptr, &VerticalBlurPixelShader));
	}
...

	{
		...
		void *HDRToneMappingPixelShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.HDRToneMapping");
		SIZE_T HDRToneMappingPixelShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.HDRToneMapping");

		SAFE_DX(Device->CreatePixelShader(HDRToneMappingPixelShaderByteCodeData, HDRToneMappingPixelShaderByteCodeLength, nullptr, &HDRToneMappingPixelShader));
	}
	...
	void *VertexShaderByteCodeData = Engine::GetEngine().GetFileSystem().GetShaderData("ShaderModel50.Test.M_Standart_1.GBufferOpaquePass_VertexShader");
	SIZE_T VertexShaderByteCodeLength = Engine::GetEngine().GetFileSystem().GetShaderSize("ShaderModel50.Test.M_Standart_1.GBufferOpaquePass_VertexShader");
	...
	SAFE_DX(Device->CreateInputLayout(InputElementDescs, 5, VertexShaderByteCodeData, VertexShaderByteCodeLength, &InputLayout));
...
void RenderDeviceD3D11::ShutdownDevice()
{
...
void RenderDeviceD3D11::TickDevice(float DeltaTime)
{
	...
	DynamicArray<PointLightComponent*> AllPointLightComponents = Engine::GetEngine().GetGameFramework().GetWorld().GetRenderScene().GetPointLightComponents();
...

	{
		...
		for (size_t k = 0; k < VisbleStaticMeshComponentsCount; k++)
		{
			...
			{
				((RenderTextureD3D11*)renderTexture0)->TextureSRV,
				((RenderTextureD3D11*)renderTexture1)->TextureSRV
			};

			ID3D11Buffer *VertexBuffers[3] =
			{
				((RenderMeshD3D11*)renderMesh)->VertexBuffer,
				((RenderMeshD3D11*)renderMesh)->VertexBuffer,
				((RenderMeshD3D11*)renderMesh)->VertexBuffer
			};
			...
			DeviceContext->IASetIndexBuffer(((RenderMeshD3D11*)renderMesh)->IndexBuffer, DXGI_FORMAT::DXGI_FORMAT_R16_UINT, 0);

			DeviceContext->VSSetShader(((RenderMaterialD3D11*)renderMaterial)->GBufferOpaquePassVertexShader, nullptr, 0);
			DeviceContext->PSSetShader(((RenderMaterialD3D11*)renderMaterial)->GBufferOpaquePassPixelShader, nullptr, 0);
...

	{
		for (int i = 0; i < 4; i++)
		{
			...
			for (size_t k = 0; k < VisbleStaticMeshComponentsCount; k++)
			{
				...
				DeviceContext->IASetVertexBuffers(0, 1, &((RenderMeshD3D11*)renderMesh)->VertexBuffer, &Stride, &Offset);
				DeviceContext->IASetIndexBuffer(((RenderMeshD3D11*)renderMesh)->IndexBuffer, DXGI_FORMAT::DXGI_FORMAT_R16_UINT, 0);

				DeviceContext->VSSetShader(((RenderMaterialD3D11*)renderMaterial)->ShadowMapPassVertexShader, nullptr, 0);
...

	{
		...
		memcpy(MappedSubResource.pData, Engine::GetEngine().GetRenderSystem().GetClusterizationSubSystem().GetLightClustersData(), 32 * 18 * 24 * 2 * sizeof(uint32_t));
		...
		memcpy(MappedSubResource.pData, Engine::GetEngine().GetRenderSystem().GetClusterizationSubSystem().GetLightIndicesData(), Engine::GetEngine().GetRenderSystem().GetClusterizationSubSystem().GetTotalIndexCount() * sizeof(uint16_t));
		...
		memcpy(MappedSubResource.pData, PointLights.GetData(), PointLights.GetLength() * sizeof(PointLight));
...

	{
		...
		DeviceContext->IASetInputLayout(SkyAndSunInputLayout);
		DeviceContext->RSSetState(RasterizerState);
		DeviceContext->OMSetBlendState(BlendDisabledBlendState, nullptr, D3D11_DEFAULT_SAMPLE_MASK);
...
RenderMesh* RenderDeviceD3D11::CreateRenderMesh(const RenderMeshCreateInfo& renderMeshCreateInfo)
{
	RenderMeshD3D11 *renderMesh = new RenderMeshD3D11();
	...
	D3D11_SUBRESOURCE_DATA SubResourceData;
	SubResourceData.pSysMem = renderMeshCreateInfo.MeshData;
	SubResourceData.SysMemPitch = 0;
	SubResourceData.SysMemSlicePitch = 0;
	...
	SubResourceData.pSysMem = (BYTE*)renderMeshCreateInfo.MeshData + renderMeshCreateInfo.VertexCount * sizeof(Vertex);
	SubResourceData.SysMemPitch = 0;
	SubResourceData.SysMemSlicePitch = 0;
...
RenderTexture* RenderDeviceD3D11::CreateRenderTexture(const RenderTextureCreateInfo& renderTextureCreateInfo)
{
	RenderTextureD3D11 *renderTexture = new RenderTextureD3D11();
...
RenderMaterial* RenderDeviceD3D11::CreateRenderMaterial(const RenderMaterialCreateInfo& renderMaterialCreateInfo)
{
	RenderMaterialD3D11 *renderMaterial = new RenderMaterialD3D11();
...
void RenderDeviceD3D11::DestroyRenderMesh(RenderMesh* renderMesh)
{
	RenderMeshDestructionQueue.Add(renderMesh);
}

void RenderDeviceD3D11::DestroyRenderTexture(RenderTexture* renderTexture)
{
	RenderTextureDestructionQueue.Add(renderTexture);
}

void RenderDeviceD3D11::DestroyRenderMaterial(RenderMaterial* renderMaterial)
{
	RenderMaterialDestructionQueue.Add(renderMaterial);
}

inline void RenderDeviceD3D11::CheckDXCallResult(HRESULT hr, const char16_t* Function)
{
	if (FAILED(hr))
	{
...
inline const char16_t* RenderDeviceD3D11::GetDXErrorMessageFromHRESULT(HRESULT hr)
{
	switch (hr)
	{
	case E_UNEXPECTED:
