...
void RenderDeviceDX11::InitDevice()
{
	...
	{
		HANDLE FullScreenQuadVertexShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/FullScreenQuad.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...

	{
		...
		HANDLE MSAADepthResolvePixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/MSAADepthResolve.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...

	{
		...
		HANDLE OcclusionBufferPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/OcclusionBuffer.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...

	{
		...
		HANDLE ShadowResolvePixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/ShadowResolve.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...

	{
		...
		HANDLE DeferredLightingPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/DeferredLighting.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
	...
	{
		HANDLE FogPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/Fog.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE SkyVertexShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/SkyVertexShader.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE SkyPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/SkyPixelShader.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE SunVertexShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/SunVertexShader.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE SunPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/SunPixelShader.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...

	{
		...
		HANDLE LuminanceCalcComputeShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/LuminanceCalc.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE LuminanceSumComputeShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/LuminanceSum.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE LuminanceAvgComputeShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/LuminanceAvg.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...

	{
		...
		HANDLE BrightPassPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/BrightPass.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE ImageResamplePixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/ImageResample.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE HorizontalBlurPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/HorizontalBlur.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE VerticalBlurPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/VerticalBlur.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...

	{
		...
		HANDLE HDRToneMappingPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/HDRToneMapping.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
	...
	HANDLE VertexShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel50/MaterialBase_VertexShader_GBufferOpaquePass.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...
void RenderDeviceDX11::ShutdownDevice()
{
...
void RenderDeviceDX11::TickDevice(float DeltaTime)
{
...

	{
		...
		for (size_t k = 0; k < VisbleStaticMeshComponentsCount; k++)
		{
			...
			RenderMeshDX11 *renderMesh = (RenderMeshDX11*)staticMeshComponent->GetStaticMesh()->GetRenderMesh();
			RenderMaterialDX11 *renderMaterial = (RenderMaterialDX11*)staticMeshComponent->GetMaterial()->GetRenderMaterial();
			RenderTextureDX11 *renderTexture0 = (RenderTextureDX11*)staticMeshComponent->GetMaterial()->GetTexture(0)->GetRenderTexture();
			RenderTextureDX11 *renderTexture1 = (RenderTextureDX11*)staticMeshComponent->GetMaterial()->GetTexture(1)->GetRenderTexture();
...
RenderMesh* RenderDeviceDX11::CreateRenderMesh(const RenderMeshCreateInfo& renderMeshCreateInfo)
{
	RenderMeshDX11 *renderMesh = new RenderMeshDX11();
...
RenderTexture* RenderDeviceDX11::CreateRenderTexture(const RenderTextureCreateInfo& renderTextureCreateInfo)
{
	RenderTextureDX11 *renderTexture = new RenderTextureDX11();
...
RenderMaterial* RenderDeviceDX11::CreateRenderMaterial(const RenderMaterialCreateInfo& renderMaterialCreateInfo)
{
	RenderMaterialDX11 *renderMaterial = new RenderMaterialDX11();
...
void RenderDeviceDX11::DestroyRenderMesh(RenderMesh* renderMesh)
{
	RenderMeshDestructionQueue.push_back(renderMesh);
}

void RenderDeviceDX11::DestroyRenderTexture(RenderTexture* renderTexture)
{
	RenderTextureDestructionQueue.push_back(renderTexture);
}

void RenderDeviceDX11::DestroyRenderMaterial(RenderMaterial* renderMaterial)
{
	RenderMaterialDestructionQueue.push_back(renderMaterial);
}

inline void RenderDeviceDX11::CheckDXCallResult(HRESULT hr, const char16_t* Function)
{
	if (FAILED(hr))
	{
...
inline const char16_t* RenderDeviceDX11::GetDXErrorMessageFromHRESULT(HRESULT hr)
{
	switch (hr)
	{
	case E_UNEXPECTED:
