...
void RenderDeviceDX11::InitSystem()
{
...
void RenderDeviceDX11::ShutdownSystem()
{
...
void RenderDeviceDX11::TickSystem(float DeltaTime)
{
	...
	for (int k = 0; k < VisbleStaticMeshComponentsCount; k++)
	{
		...
		RenderTextureDX11 *renderTexture = (RenderTextureDX11*)staticMeshComponent->GetMaterial()->GetTexture(0)->GetRenderTexture();
