...
void RenderDeviceDX12::InitDevice()
{
	...
	SAFE_DX(Factory->CreateSwapChainForHwnd(GraphicsCommandQueue, Application::GetMainWindowHandle(), &SwapChainDesc, &SwapChainFullScreenDesc, nullptr, &SwapChain1));
	...
	HANDLE FullScreenQuadVertexShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/FullScreenQuad.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...

	{
		...
		HANDLE OcclusionBufferPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/OcclusionBuffer.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...

	{
		...
		HANDLE ShadowResolvePixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/ShadowResolve.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...

	{
		...
		HANDLE DeferredLightingPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/DeferredLighting.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...

	{
		...
		GraphicsCommandList->CopyBufferRegion(SkyVertexBuffer, 0, UploadBuffer, 0, sizeof(Vertex) * SkyMeshVertexCount);
		GraphicsCommandList->CopyBufferRegion(SkyIndexBuffer, 0, UploadBuffer, sizeof(Vertex) * SkyMeshVertexCount, sizeof(WORD) * SkyMeshIndexCount);
		...
		SAFE_DX(GraphicsCommandQueue->Signal(CopySyncFence, 1));
		...
		HANDLE SkyVertexShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/SkyVertexShader.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE SkyPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/SkyPixelShader.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		GraphicsCommandList->CopyBufferRegion(SunVertexBuffer, 0, UploadBuffer, 0, sizeof(Vertex) * SunMeshVertexCount);
		GraphicsCommandList->CopyBufferRegion(SunIndexBuffer, 0, UploadBuffer, sizeof(Vertex) * SunMeshVertexCount, sizeof(WORD) * SunMeshIndexCount);
		...
		HANDLE SunVertexShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/SunVertexShader.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE SunPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/SunPixelShader.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE FogPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/Fog.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...

	{
		...
		HANDLE LuminanceCalcComputeShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/LuminanceCalc.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE LuminanceSumComputeShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/LuminanceSum.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE LuminanceAvgComputeShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/LuminanceAvg.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...

	{
		...
		HANDLE BrightPassPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/BrightPass.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE ImageResamplePixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/ImageResample.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE HorizontalBlurPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/HorizontalBlur.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
		...
		HANDLE VerticalBlurPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/VerticalBlur.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...

	{
		...
		HANDLE HDRToneMappingPixelShaderFile = CreateFile((const wchar_t*)u"GameContent/Shaders/ShaderModel51/HDRToneMapping.dxbc", GENERIC_READ, 0, NULL, OPEN_EXISTING, 0, NULL);
...
void RenderDeviceDX12::ShutdownDevice()
{
...
void RenderDeviceDX12::TickDevice(float DeltaTime)
{
...

	{
		...
		{
			GBufferOpaquePassConstantBufferStruct& ConstantBuffer = *((GBufferOpaquePassConstantBufferStruct*)((BYTE*)ConstantBufferData + ConstantBufferOffset));
		...
		GraphicsCommandList->CopyBufferRegion(GPUConstantBuffer, 0, CPUConstantBuffers[CurrentFrameIndex], 0, ConstantBufferOffset);
		...
		for (size_t k = 0; k < VisbleStaticMeshComponentsCount; k++)
		{
			...
			RenderTextureDX12 *renderTexture0 = (RenderTextureDX12*)Material->GetTexture(0)->GetRenderTexture();
			RenderTextureDX12 *renderTexture1 = (RenderTextureDX12*)Material->GetTexture(1)->GetRenderTexture();
...

	{
		for (int i = 0; i < 4; i++)
		{
			...
			for (size_t k = 0; k < VisbleStaticMeshComponentsCount; k++)
			{
				...
				ShadowMapPassConstantBufferStruct& ConstantBuffer = *((ShadowMapPassConstantBufferStruct*)((BYTE*)ConstantBufferData + ConstantBufferOffset));
			...
			GraphicsCommandList->CopyBufferRegion(GPUConstantBuffers2[i], 0, CPUConstantBuffers2[i][CurrentFrameIndex], 0, ConstantBufferOffset);
...

	{
		...
		ShadowResolveConstantBufferStruct& ConstantBuffer = *((ShadowResolveConstantBufferStruct*)((BYTE*)ConstantBufferData));
...

	{
		...
		DeferredLightingConstantBufferStruct& ConstantBuffer = *((DeferredLightingConstantBufferStruct*)((BYTE*)ConstantBufferData));
		...
		GraphicsCommandList->ResourceBarrier(8, ResourceBarriers);

		GraphicsCommandList->CopyBufferRegion(GPUDeferredLightingConstantBuffer, 0, CPUDeferredLightingConstantBuffers[CurrentFrameIndex], 0, 256);
		...
		GraphicsCommandList->CopyBufferRegion(GPULightIndicesBuffer, 0, CPULightIndicesBuffers[CurrentFrameIndex], 0, clusterizationSubSystem.GetTotalIndexCount() * sizeof(uint16_t));
		GraphicsCommandList->CopyBufferRegion(GPUPointLightsBuffer, 0, CPUPointLightsBuffers[CurrentFrameIndex], 0, PointLights.size() * sizeof(PointLight));
		...
		GraphicsCommandList->ResourceBarrier(4, ResourceBarriers);
...

	{
		...
		SkyConstantBufferStruct& skyConstantBuffer = *((SkyConstantBufferStruct*)((BYTE*)ConstantBufferData));
		...
		SunConstantBufferStruct& sunConstantBuffer = *((SunConstantBufferStruct*)((BYTE*)ConstantBufferData));
...

	{
		...
		GraphicsCommandList->SetComputeRootDescriptorTable(1, D3D12_GPU_DESCRIPTOR_HANDLE{ ResourceGPUHandle.ptr + 0 * ResourceHandleSize });
		GraphicsCommandList->SetComputeRootDescriptorTable(3, D3D12_GPU_DESCRIPTOR_HANDLE{ ResourceGPUHandle.ptr + 1 * ResourceHandleSize });

		GraphicsCommandList->DiscardResource(SceneLuminanceTextures[0], nullptr);

		ResourceGPUHandle.ptr += 2 * ResourceHandleSize;

		GraphicsCommandList->Dispatch(80, 45, 1);
		...
		GraphicsCommandList->DiscardResource(SceneLuminanceTextures[1], nullptr);
		...
		GraphicsCommandList->DiscardResource(SceneLuminanceTextures[2], nullptr);

		ResourceGPUHandle.ptr += 2 * ResourceHandleSize;

		GraphicsCommandList->Dispatch(5, 3, 1);
		...
		GraphicsCommandList->DiscardResource(SceneLuminanceTextures[3], nullptr);
...
RenderMesh* RenderDeviceDX12::CreateRenderMesh(const RenderMeshCreateInfo& renderMeshCreateInfo)
{
	RenderMeshDX12 *renderMesh = new RenderMeshDX12();
...
RenderTexture* RenderDeviceDX12::CreateRenderTexture(const RenderTextureCreateInfo& renderTextureCreateInfo)
{
	RenderTextureDX12 *renderTexture = new RenderTextureDX12();
...
RenderMaterial* RenderDeviceDX12::CreateRenderMaterial(const RenderMaterialCreateInfo& renderMaterialCreateInfo)
{
	RenderMaterialDX12 *renderMaterial = new RenderMaterialDX12();
...
void RenderDeviceDX12::DestroyRenderMesh(RenderMesh* renderMesh)
{
	RenderMeshDestructionQueue.push_back(renderMesh);
}

void RenderDeviceDX12::DestroyRenderTexture(RenderTexture* renderTexture)
{
	RenderTextureDestructionQueue.push_back(renderTexture);
}

void RenderDeviceDX12::DestroyRenderMaterial(RenderMaterial* renderMaterial)
{
	RenderMaterialDestructionQueue.push_back(renderMaterial);
}

inline void RenderDeviceDX12::CheckDXCallResult(HRESULT hr, const char16_t* Function)
{
	if (FAILED(hr))
	{
...
inline const char16_t* RenderDeviceDX12::GetDXErrorMessageFromHRESULT(HRESULT hr)
{
	switch (hr)
	{
		case E_UNEXPECTED:
