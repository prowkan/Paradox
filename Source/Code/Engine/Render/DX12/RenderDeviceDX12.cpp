...
void RenderDeviceDX12::InitSystem()
{
...
void RenderDeviceDX12::ShutdownSystem()
{
...
void RenderDeviceDX12::TickSystem(float DeltaTime)
{
	if (FrameSyncFences[CurrentFrameIndex]->GetCompletedValue() != 1)
	{
		SAFE_DX(FrameSyncFences[CurrentFrameIndex]->SetEventOnCompletion(1, FrameSyncEvent));
	...
	for (int k = 0; k < VisbleStaticMeshComponentsCount; k++)
	{
		...
		RenderTextureDX12 *renderTexture = (RenderTextureDX12*)staticMeshComponent->GetMaterial()->GetTexture(0)->GetRenderTexture();
