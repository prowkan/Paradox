...
VSOutput VS(uint VertexID : SV_VertexID)
{
	...
	{
		VertexShaderOutput.Position = float4(-0.6f, 1.0f, 0.0f, 1.0f);
		VertexShaderOutput.TexCoord = float2(1.0f, 0.0f);
	}
	else if (VertexID == 2)
	{
		VertexShaderOutput.Position = float4(-1.0f, 0.6f, 0.0f, 1.0f);
		VertexShaderOutput.TexCoord = float2(0.0f, 1.0f);
	}
	else if (VertexID == 3)
	{
		VertexShaderOutput.Position = float4(-0.6f, 0.6f, 0.0f, 1.0f);
